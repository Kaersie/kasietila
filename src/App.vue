...
function moon() {
    if (document.querySelector('s-page').theme == 'dark') {
        document.querySelector('s-page').theme = 'light'
    } else {
        document.querySelector('s-page').theme = 'dark'
    }
}//change the light or dark
</script>

<template>
    <s-navigation>
        <s-navigation-item selected="true">
            <svg xmlns="http://www.w3.org/2000/svg" slot="icon" width="16" height="16" fill="currentColor"
